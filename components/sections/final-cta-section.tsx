      ...
      <div className="mx-auto max-w-7xl">
        <Reveal>
          <div className="max-w-4xl">
            ...
            <a href="/contact" className="mt-10 inline-flex min-h-12 items-center gap-3 border border-[var(--background)] px-6 py-3 text-sm font-medium transition-colors duration-200 hover:bg-[var(--background)] hover:text-[var(--surface)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]">
              Start a project
