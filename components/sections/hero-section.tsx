      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_280px] lg:items-end lg:gap-16">
          <div className="max-w-5xl">
            ...
            >
              ...
              <div className="flex shrink-0 flex-wrap gap-3">
                <a
                  href="/work"
                  className="group inline-flex min-h-12 items-center justify-center gap-2 border border-white bg-white px-5 text-sm font-medium text-black transition-colors hover:bg-transparent hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
                >
                  View my work
                ...
                <a
                  href="/contact"
                  className="inline-flex min-h-12 items-center justify-center border border-zinc-700 px-5 text-sm font-medium text-white transition-colors hover:border-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
                >
                  Start a project
                </a>
              </div>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            transition={{ duration: 0.8, delay: shouldReduceMotion ? 0 : 0.55 }}
        ...
        <motion.a
          ...
          className="mt-16 inline-flex items-center gap-3 text-xs uppercase tracking-[0.2em] text-zinc-500 transition-colors hover:text-white sm:mt-20"
        >
          Scroll to explore
